...
<head>
<meta charset="UTF-8">
<title>/views/gallery1/ajax_form.jsp</title>
</head>
<body>
	<div class="container">
   		<form action="${pageContext.request.contextPath}/gallery1/insert" method="post" id="insertForm">
   		...
   		<form action="${pageContext.request.contextPath}/gallery1/ajax_upload" method="post" id="ajaxForm" enctype="multipart/form-data">
      		<div>
	...
	<script>
		...
		document.querySelector("#image").addEventListener("change", function(){
			...
			.then(function(data){
				...
				const path = "${pageContext.request.contextPath}/gallery1/images/" + data.imagePath;
				//img 태그에 경로 추가
