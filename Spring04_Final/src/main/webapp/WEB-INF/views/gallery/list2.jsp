...
<body>
	<div class="container">
		...
		<div class="row cols-1 cols-md-4 g-4 mt-1">
			<c:forEach var="tmp" items="${list }">
				<div class="col">
					<div class="card" style="width: 9rem;">
						<img id="imagePath" width="50" height="50" class="card-img-top rounded" alt="thumbnail"
						src="${pageContext.request.contextPath }${tmp.imagePath}">
						
						<div class="card-body">
							<h4 class="card-title"><strong>${tmp.caption }</strong></h4>
						</div>
						...
						<div class="card-body">
							<a href="detail?num=${tmp.num }" class="btn btn-primary" style="float: right;">원본보기</a>
						</div>
